...
def main(JSONArray, outputFileName, wavelength=None, spectrum=None, downwellingFlux=None, recordTime=None, commandLine=None):
    ...
    setattr(netCDFHandler.variables['wvl_dlt'], 'notes', 
    "Best information available is that bandwidth is uniform 0.4 nm across all channels")
    setattr(netCDFHandler.variables[
            'wvl_dlt'], 'long_name', "Bandwidth of environmental sensor")

    netCDFHandler.createVariable("flx_sns", "f4", ("wvl_lgr",))[:] = [members/1e-6 for members in _FLX_SNS]
